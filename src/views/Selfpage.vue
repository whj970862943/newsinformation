...
<div id="selfpage">
    ...
    <div class="myActive">
        <div class="self_con">
            <div class="self_items clearfix" v-for="(item,index) in selfComment" :key="index">
                <img src="../assets/imgs/head.jpg" alt="" class="fl self_head">
                <div class="rightInfo">
                    <p class="self_name">{{userInfo.name}}</p>
                    ...
                    params:
                        ...
                        <img :src="img.url" v-show="index === 1" alt="" v-for="(img,index) in item.image_list" :key="index" class="fl news_img">
...
export default {
    ...
    methods: {
        ...
        getSelfComment(){
            axios.get('/static/self_comment.json')
                .then(res => {
                    const Data = res.data;
