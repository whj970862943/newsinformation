...
<!-- 
        ...
        <div class="zan">
            ...
            <Button  size="large" icon="trash-a" shape="circle">不喜欢</Button>
        </div>
        <hr>
    </div>
    <comment type="ghost" clsss="comment" :comment="comment_count"></comment>
    <shareBox type="ghost" :show="Sharebox"></shareBox>
</div>
</template>
<script>
